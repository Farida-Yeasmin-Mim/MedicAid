...
<i class="fas fa-check"style="color:blue"></i>Time it takes: About 1 hour<br>

<i class="fas fa-check"style="color:blue"></i>Ideal blood types: All blood types<br>

<i class="fas fa-check"style="color:blue"></i>Donation frequency: Every 56 days</p>
...
<i class="fas fa-check"style="color:blue"></i>Ideal blood types: O positive, O negative, A negative, and B negative<br>

<i class="fas fa-check"style="color:blue"></i>Donation frequency: Every 112 days, up to 3 times/year. <br>
<br>
<br>
<br>
...
<i class="fas fa-check"style="color:blue"></i>Platelets are collected at Red Cross donation centers only, and are not collected at blood drives. Learn more about platelet donations.<br>
<i class="fas fa-check"style="color:blue"></i>Who it helps: Platelets are a vital element of cancer treatments and organ transplant procedures, as well as other surgical procedures.<br>
<i class="fas fa-check"style="color:blue"></i>Time it takes: About 2.5-3 hours<br>

<i class="fas fa-check"style="color:blue"></i>Ideal blood types: A positive, A negative, B positive, O positive, AB positive and AB negative<br>

<i class="fas fa-check"style="color:blue"></i>Donation frequency: Every 7 days, up to 24 times/year<br>
<br>
<br>
<br>
...
<i class="fas fa-check"style="color:blue"></i>Time it takes: About 1 hour and 15 minutes<br>

<i class="fas fa-check"style="color:blue"></i>Ideal blood types: AB positive, AB negative<br>

<i class="fas fa-check"style="color:blue"></i>Donation frequency: Every 28 days, up to 13 times/year<br>
<br>
