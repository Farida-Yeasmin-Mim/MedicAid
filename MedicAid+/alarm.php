...
<html lang="en" dir="ltr">
  ...
  <section class="ftco-hireme bg-info">
    <div class="container">
        <div class="col-lg-10 col-md-15 mx-auto text-center">
          <br>
          <p class="text-white">SAFETY FIRST! As the COVID-19 pandemic continues,
            the MedicAid is adapting Sound the Alarm activities to protect the people we serve and our volunteers. Sound the Alarm may look different
            this year but our lifesaving mission to make families and communities safer from home fire continues. </p>
            <br>
        </div>
    </div>
  </section>
